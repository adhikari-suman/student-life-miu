...
public class CompanyApplication {
    public static void main(String[] args) {
        ...
        Department d3 = new Department("Top Management", "1000 N. 4th St., Fairfield, IA, 52557");
        ...
        Position d3p1 = new Position("CEO", "CEO of company");
        ...
        Employee e5 = new Employee(1, "John", null, "Cena", LocalDate.of(1991, 1, 23), "453267", 39500);
        ...
        // assign downLines
        // CEO is reported by VP and Project Manager
        d3p1.addDownLine(d1p1);
        d3p1.addDownLine(d2p2);

        d2p2.addDownLine(d2p1);

        d2p1.addDownLine(d2p3);

        d1p1.addDownLine(d1p2);
        d1p1.addDownLine(d1p3);

        // Print company details
        c.print();


        System.out.println("Company total Salary: "+c.getSalary());


        System.out.println("\n\n*************************************************************");
        System.out.println("** Company reporting hierarchies");
        System.out.println("*************************************************************");
