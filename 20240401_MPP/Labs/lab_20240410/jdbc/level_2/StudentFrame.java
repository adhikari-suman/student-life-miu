package lab_20240410.jdbc.level_2;
...
public class StudentFrame extends JFrame {
    ...
    void BdoUpdate_actionPerformed(ActionEvent event) {
        ...
        dbconnect.DoUpdate("UPDATE StudentInfo SET GPA = 2.5 WHERE StudentID = '123-456';");

        dbconnect.DoUpdate("INSERT INTO StudentInfo([StudentID], [StudentName], [Age],[GPA]) VALUES('189-242', 'Ariel',30, 4)");
