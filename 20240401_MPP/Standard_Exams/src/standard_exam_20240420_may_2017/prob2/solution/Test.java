...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println(Admin.getPhoneNums(members, getCd(cds)));


	}

	private static CD getCd(CD[] cds) {
		return cds[1];
	}
