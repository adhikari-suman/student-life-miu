package standard_exam_20240406.prob2.launch;

import standard_exam_20240406.prob2.*;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		Employee e3 = new Employee("Tom");
			...
			e1.addAccount(someCheckingAccounts[0]); // 75
			e1.addAccount(someSavingsAccounts[0]); // 206
			e2.addAccount(someCheckingAccounts[1]); // 175
			e2.addAccount(someSavingsAccounts[1]);  // 206
			e3.addAccount(someSavingsAccounts[2]); // 624
