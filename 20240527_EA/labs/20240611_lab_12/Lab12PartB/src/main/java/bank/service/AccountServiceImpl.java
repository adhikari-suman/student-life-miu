...
public class AccountServiceImpl implements AccountService {
    ...
    public Page<AccountResponse> getAllAccounts(Pageable pageable) {
        return accountRepository.findAll(pageable).map((element) -> modelMapper.map(element, AccountResponse.class));
    }

    public Collection<AccountResponse> getAllAccounts() {
        return accountRepository.findAll().stream().map((element) -> modelMapper.map(element, AccountResponse.class)).collect(Collectors.toList());
    }
    ...
    public void withdraw(long accountNumber, double amount) {
        ...
        eventPublisher.publishEvent(new TransactionEvent(
                ...
                null,
                "withdraw with parameters accountNumber= " + accountNumber + " , amount= " + amount
        ));
    ...
    public void depositEuros(long accountNumber, double amount) {
        ...
        eventPublisher.publishEvent(new TransactionEvent(
                ...
                TransactionType.DEPOSIT,
                null,
                "deposit with parameters accountNumber= " + accountNumber + " , amount= " + amountDollars
        ));
