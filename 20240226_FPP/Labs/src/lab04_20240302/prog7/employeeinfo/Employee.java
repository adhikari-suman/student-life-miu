...
import lab04_20240302.prog7.MyStringList;
...
//	}
	...
	public int compareTo(Employee o) {
		Account a = this.accounts.getLargest();
		Account b = o.accounts.getLargest();
		
		// Account has impl for compareTo with Double wrapper class compareTo for comparison
