...
class EmployeeControllerTest {
    ...
    private EmployeeRequestDto employeeRequestDto = new EmployeeRequestDto("John", "Doe", "john.doe@gmail.com", "IT");

    private EmployeeResponseDto employeeResponseDto = new EmployeeResponseDto("John", "Doe", "IT");
    ...
    void givenNothing_whenGetEmployees_thenReturnAllEmployees() throws Exception {
        // given
        ...
        mockMvc.perform(
               ...
               .andExpectAll(
                       ...
                       MockMvcResultMatchers.jsonPath("$[1].firstName").value("Jane"),
    ...
    void givenEmployeeRequestDtoWithExistingEmail_whenCreate_thenReturnBadRequest() throws Exception {
        ...
        Mockito.when(employeeService.findByEmail(employeeRequestDto.email())).thenThrow(
