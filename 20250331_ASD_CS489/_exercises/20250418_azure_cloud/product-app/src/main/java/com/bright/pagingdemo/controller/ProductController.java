...
public class ProductController {
    ...
    public ResponseEntity<Page<ProductResponseDto>> searchProducts(
        ...
        Page<ProductResponseDto> productResponseDtoPage = productService.searchProducts(page, pageSize, sortDirection,
                                                                                        sortBy
                                                                                       );
    ...
    public ResponseEntity<Page<ProductResponseDto>> searchProductsByCategory(
        ...
        Page<ProductResponseDto> productResponseDtoPage = productService.searchProductsByCategory(
                category,
                page,
                pageSize,
                sortDirection,
